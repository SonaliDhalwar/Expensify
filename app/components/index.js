const { default: expenses } = require("./LandingPage/selectors/expenses");
...
export expenses from './LandingPage/selectors/expenses';
export configureStore from './LandingPage/store/configureStore';
